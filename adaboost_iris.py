...
# =====================================================
# ADABOOST CLASSIFICATION - IRIS DATASET
# =====================================================
...
print("=" * 60)
print("ADABOOST CLASSIFICATION - IRIS DATASET")
print("=" * 60)
...
for i in range(min(5, len(X_test))):
    ...
    confidence = ada_model.predict_proba(X_test.iloc[i].values.reshape(1, -1)).max()
...
prediction = ada_model.predict(new_sample_values)[0]
confidence = ada_model.predict_proba(new_sample_values)[0]
...
# Model Details
print("\n" + "=" * 60)
print("ADABOOST MODEL DETAILS")
print("=" * 60)
print(f"\nNumber of estimators: {ada_model.n_estimators}")
print(f"Learning rate: {ada_model.learning_rate}")
print(f"Algorithm: {ada_model.algorithm}")
print(f"Base estimator max depth: 3")
print(f"Random state: {ada_model.random_state}")
